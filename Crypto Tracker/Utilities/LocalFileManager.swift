...
class LocalFileManager {
    ...
    private func createFolderIfNeeded(folderName:String){
        ...
        guard let url = getURLForFolders(folderName: folderName) else { return }
    ...
    private func getURLForFolders(folderName:String) -> URL? {
    ...
    private func getURLForImage(imageName:String,folderName:String)-> URL?{
        ...
        guard let folderURL = getURLForFolders(folderName: folderName)
        else {return nil}
